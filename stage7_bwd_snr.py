"""Stage 7 Tier 2 validation: CK VSA bwd vs Triton SLA bwd.

Runs a reference Triton backward (via SLA's autograd.Function) and the
new CK VSA backward on identical inputs, then diffs dQ / dK / dV with SNR.

Gate: dq/dk/dv SNR > 30 dB (bf16 accumulation noise headroom).
"""
import sys
